                ...
                <div class="container">
                    ...
                    <div class="f-right responsive-nav">
                        ...
                        <nav class="top-nav nav-animate to-bottom">
                            <ul>
                                <li class="mega-menu"><a href="#">Home</a>
									<ul>
										<li class="col-md-4">
											<h4>Home Set 1</h4>
											<ul>
												...
												<li><a href="index-corporate-5.html">Home Corporate 5</a></li>
											</ul>
										</li>
										<li class="col-md-4">
											<h4>Home Set 2</h4>
											<ul>
												...
												<li><a href="index-fullscreen-1.html">Home Full Screen 1</a></li>
												<li><a href="index-fullscreen-2.html">Home Full Screen 2</a></li>
												<li><a href="index-fullscreen-3.html">Home Full Screen 3</a></li>
										...
										<li class="col-md-4">
											...
											<ul>
												...
												<li><a href="index-magazine-1.html">Home News Magazine 1</a></li>
												<li><a href="index-magazine-2.html">Home News Magazine 2</a></li>
											</ul>
										</li>
										<li class="col-md-4">
											<h4>Home Set 4</h4>
											<ul>
												<li><a href="one-page-1.html">One Page 1</a></li>
												<li><a href="one-page-2.html">One Page 2</a></li>
												<li><a href="one-page-3.html">One Page 3</a></li>
                                ...
                                <li><a href="#">Features</a>
                                    <ul>
                                    <li>
                                        <a href="#"><i class="fa fa-sliders"></i>Sliders</a>
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="slider-revolution-boxed.html">Boxed</a></li>
                                                    <li><a href="slider-revolution-kenburns.html">Ken Burns</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                    ...
                                    <li><a href="#"><i class="fa fa-send"></i>Headers</a>
										<ul>
											<li><a href="#">Transparent Header</a>
												<ul>
													<li><a href="index-corporate-1.html">Transparent Header 1 Boxed</a></li>
													<li><a href="header-transparent-1-fluid.html">Transparent Header 1 Fluid</a></li>
													<li><a href="header-transparent-2.html">Transparent Header 2</a></li>
													<li><a href="header-transparent-3-boxed.html">Transparent Header 3 Boxed</a></li>
													<li><a href="header-transparent-3-fluid.html">Transparent Header 3 Fluid</a></li>
												</ul>
											</li>
											<li><a href="#">Semi Transparent Header</a>
												<ul>
													<li><a href="header-semi-transparent-light.html">Light Header</a></li>
													<li><a href="header-semi-transparent-dark.html">Dark Header</a></li>
												</ul>
											</li>
											...
											<li><a href="menu-animations.html">Menu Animations</a></li>
										</ul>
									</li>
                                    <li><a href="#"><i class="fa fa-server"></i>Footers</a>
                                        <ul>
                                            <li><a href="footer-2.html#footWrapper">Footer Version 2</a></li>
                                            <li><a href="footer-3.html#footWrapper">Footer Version 3</a></li>
                                            <li><a href="footer-4.html#footWrapper">Footer Version 4</a></li>
                                            <li><a href="footer-light.html#footWrapper">Light Colored Footer</a></li>
                                            <li><a href="footer-minimal-1.html#footWrapper">Minimal Footer 1</a></li>
                                            <li><a href="footer-minimal-2.html#footWrapper">Minimal Footer 2</a></li>
                                            <li><a href="footer-minimal-3.html#footWrapper">Minimal Footer 3</a></li>
                                            <li><a href="footer-minimal-4.html#footWrapper">Minimal Footer 4</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#"><i class="fa fa-bars"></i>Sub Menus</a>
                                        <ul>
                                            <li><a href="index.html">Default Sub Menu</a></li>
                                            <li><a href="sub-menu-dark.html">Dark Sub Menu</a></li>
                                            <li><a href="sub-menu-colored.html">Colored Sub Menu</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#"><i class="fa fa-bookmark"></i>Page Titles</a>
                                        <ul>
                                            <li><a href="page-title.html">Normal Page Title</a></li>
                                            <li><a href="page-title-icon.html">Page Title with Icon</a></li>
                                            <li><a href="page-title-parallax.html">Page Title Parallax</a>
                                                <ul>
                                            ...
                                            <li><a href="page-title-center-2.html">Centered Page Title 2</a></li>
                                ...
                                <li><a href="#">Portfolio</a>
                                    <ul>
                                        <li><a href="#">Grid Layout</a>
                                            <ul>
                                                <li><a href="portfolio-grid-1-col.html">1 column</a></li>
                                ...
                                <li class="selected"><a href="#">Pages</a>
                                    <ul>
                                        ...
                                        <li><a href="team.html">Team Boxes</a></li>
                                        <li><a href="#">Pages</a>
                                            <ul>
                                        ...
                                        <li><a href="#">Register</a>
                                            <ul>
                                                <li><a href="register-1.html">Register Style 1</a></li>
                                                <li><a href="register-2.html">Register Style 2</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">Product Page</a>
                                            <ul>
                                                ...
                                                <li><a href="product-left-bar.html">Left Side Bar</a></li>
					...
					<div class="container">
						<div class="row">
							...
							<div class="breadcrumbs">
								<a href="#">Home</a><i class="fa fa-long-arrow-right main-color"></i><a href="#">Pages</a><i class="fa fa-long-arrow-right main-color"></i><span>Contact Us</span>
							</div>
				...
				<div class="section">
                    <div class="container">
                        <div class="row">
                             ...
                             <div class="col-md-9">
                                <div class="heading">
                                    <h1 class="bold head-6 main-color font-20 uppercase">Leave A Message</h1>
                                    <p class="sub-heading block">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eget lacus sit amet neque posuere aliquet. In interdum nisl sapien, vel dignissim nulla porta at.</p>
                                </div>
                                <div class="side_contact" id="contact">
                                    ...
                                    <form class="form-signin cform" method="post" action="assets/php/contact.php" id="cform" autocomplete="on">
                                        <div class="form-input">
                                            <input type="text" class="form-control shape" required="required" name="name" id="name" placeholder="Your Name">
                                        </div>
                                        <div class="form-input">
                                            <input name="email" type="email" class="form-control shape" id="email" required="required" placeholder="Email Address">
                                        </div>
                                        <div class="form-input">
                                            <input name="phone" type="text" class="form-control shape" id="phone" placeholder="Phone Number">                                        
                                        </div>
                                        <div class="form-input">
                                            <textarea required="required" class="shape" name="message" cols="40" rows="7" id="messageTxt" spellcheck="true" placeholder="Your Message"></textarea>
                                        </div>
                                        <div class="form-input clearfix captcha-div-lft">
                                            ...
                                            <input id="captcha_input" class="sm-txtbox" name="captcha_input" type="text" required="required" placeholder="Enter the code here">
                                        </div>
                                        <div class="form-input clearfix margin-top-20">
                                            <input type="submit" class="btn btn-xl main-bg submit-btn shape" value="Send Message">
                                        </div>
                                    </form>
                                </div>
                             </div>
                             ...
                             <div class="col-md-3">
                                <div class="heading padding-bottom-0">
                                    <h3 class="bold head-6 main-color font-20 uppercase">Find Us</h3>
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eget lacus sit amet neque posuere aliquet. In interdum nisl sapien, vel dignissim nulla porta at.</p>
                                ...
                                <div class="side-socials padding-vertical-40">
                                    <ul class="social-list">
                                        <li class="main-bg border3px"><a data-tooltip="true" data-title="dribbble" href="#" class="fa fa-dribbble"></a></li>
                                        <li class="main-bg border3px"><a data-tooltip="true" data-title="facebook" href="#" class="fa fa-facebook"></a></li>
                                        <li class="main-bg border3px"><a data-tooltip="true" data-title="linkedin" href="#" class="fa fa-linkedin"></a></li>
                                        <li class="main-bg border3px"><a data-tooltip="true" data-title="skype" href="#" class="fa fa-skype"></a></li>
                                        <li class="main-bg border3px"><a data-tooltip="true" data-title="twitter" href="#" class="fa fa-twitter"></a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="icon-box box-1">
                                    <div class="block-icon eff-2 filled lg-icon shape">
                                        <i class="fa fa-map-marker"></i>
                                    </div>
                                    <h3 class="t-center">Address</h3>
                                    <p class="t-center">123, Second Sunrise <br>Avenue New York,USA</p>
                            ...
                            <div class="col-md-4">
                                <div class="icon-box box-1">
                                    ...
                                    <h3 class="t-center">E-mail Address</h3>
                                    <p class="t-center">
                                        info@it-rays.net<br>
                                        email@domain.com
                                    </p>
